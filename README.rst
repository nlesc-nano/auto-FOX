################################################################################
Automated Forcfield Optimization Extension
################################################################################
...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_Auto-FOX``)
...
* For convenience, the package version is stored in a single place: ``Auto-FOX/__version__.py``. For updating the version number, you only have to change this file.
...
To install Auto-FOX, do:

.. code-block:: console

  git clone https://github.com//Auto-FOX.git
  cd Auto-FOX
  pip install .
...
If you want to contribute to the development of Automated Forcfield Optimization Extension,
