...
class FromResult(Generic[FT, RT], types.FunctionType, metaclass=ABCMeta):
    ...
    @overload
    @classmethod
    def _reduce(cls, value: T1, reduce: Float64Names, axis: ShapeLike) -> ScalarOrArray[np.float64]: ...
    @overload
    @classmethod
    def _reduce(cls, value: T1, reduce: IntPNames, axis: None = ...) -> np.intp: ...
    @overload
    @classmethod
    def _reduce(cls, value: T1, reduce: IntPNames, axis: ShapeLike) -> ScalarOrArray[np.intp]: ...
    @overload
    @classmethod
    def _reduce(cls, value: T1, reduce: BoolNames, axis: None = ...) -> np.bool_: ...
    @overload
    @classmethod
    def _reduce(cls, value: T1, reduce: BoolNames, axis: ShapeLike) -> ScalarOrArray[np.bool_]: ...

    @staticmethod
    def _pop(dct: MutableMapping[str, T2], key: str, callback: Callable[[], T2]) -> T2: ...
...
@overload
def get_attr(obj: object, name: str, default: Any = ..., *, reduce: Float64Names, axis: ShapeLike) -> ScalarOrArray[np.float64]: ...
@overload
def get_attr(obj: object, name: str, default: Any = ..., *, reduce: IntPNames, axis: None = ...) -> np.intp: ...
@overload
def get_attr(obj: object, name: str, default: Any = ..., *, reduce: IntPNames, axis: ShapeLike) -> ScalarOrArray[np.intp]: ...
@overload
def get_attr(obj: object, name: str, default: Any = ..., *, reduce: BoolNames, axis: None = ...) -> np.bool_: ...
@overload
def get_attr(obj: object, name: str, default: Any = ..., *, reduce: BoolNames, axis: ShapeLike) -> ScalarOrArray[np.bool_]: ...
...
@overload
def call_method(obj: object, name: str, *args: Any, reduce: Float64Names, axis: ShapeLike, **kwargs: Any) -> ScalarOrArray[np.float64]: ...
@overload
def call_method(obj: object, name: str, *args: Any, reduce: IntPNames, axis: None = ..., **kwargs: Any) -> np.intp: ...
@overload
def call_method(obj: object, name: str, *args: Any, reduce: IntPNames, axis: ShapeLike, **kwargs: Any) -> ScalarOrArray[np.intp]: ...
@overload
def call_method(obj: object, name: str, *args: Any, reduce: BoolNames, axis: None = ..., **kwargs: Any) -> np.bool_: ...
@overload
def call_method(obj: object, name: str, *args: Any, reduce: BoolNames, axis: ShapeLike, **kwargs: Any) -> ScalarOrArray[np.bool_]: ...
